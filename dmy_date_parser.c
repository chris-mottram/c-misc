...
** cc dmy_date_parser.c -o dmy_date_parser
** $Header: /home/cjm/cjm/c/misc/RCS/dmy_date_parser.c,v 1.1 2010/01/27 12:08:27 cjm Exp $
*/
...
int main(int argc, char *argv[])
{
	...
	/*	fprintf(stdout,"dt1 %.2f = time_secs %lu * ONE_SECOND_MS %d\n",dt1,time_secs,ONE_SECOND_MS);*/
...
static void Help(void)
{
	fprintf(stderr,"dmy_date_parser <date>\n");
	fprintf(stderr,"Parses a date of the form: 22-01-2010T07:38:48.099\n");
